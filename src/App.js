...
function App() {
  ...
  const [expensesList, setExpensesList] = useState(
    JSON.parse(localStorage.getItem('expensesList')) || [
      { title: 'Kerala-Goa', price: 1300, category: 'Travel', date: '25/08/2023' },
      { title: 'Movie', price: 150, category: 'Entertainment', date: '25/02/2024' },
      { title: 'Chicken', price: 100, category: 'Food', date: '26/02/2024' }
    ]
  );
